...
<body>
	...
	<div>
	<div><img style="float:left" width="300px" src="img/vector/desbloqueado.png" /></div>
	<h1>Activo nuevamente!</h1>
		El usuario ha recuperado el acceso al sistema <BR>
        A partir de ahora podrá acceder al sistema y disfrutar de todas sus funciones
	</div>
	<hr>
